...
local msgtaha = 500
local msggstaha = database:get(bot_id..'Tshake:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0  
local nupmsgg =  tonumber((msggstaha / msgtaha) * 10)   
local msguser = tonumber(database:get(bot_id..'Tshake:msg:user'..msg.chat_id_..':'..msg.sender_user_id_) or 1) 
local tahamsg = (database:get(bot_id..'Tshake:messageUser'..msg.chat_id_..':'..msg.sender_user_id_) or 0) 
local Texting = {
'صورتك فدشي 😘😔❤️',
"صارلك شكد مخليه ",
"وفالله 😔💘",
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg)  then
function Function_Tshake(extra, result, success)
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevBot(msg) then
function Function_Tshake(extra, result, success)
database:srem(bot_id.."Tshake:GBan:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","💢┇تم الغاء حظره عام من المجموعات")  
end
